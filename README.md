...
***Note** The current master branch works fine locally but when I published to IIS it is having issues with .net7 and IS4. Open to PR's but recommend using the .net6 Maui branch for now. Thanks
